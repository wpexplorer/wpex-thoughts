...
if ( ! class_exists( 'WPEX_Gallery_Metabox' ) ) {
    class WPEX_Gallery_Metabox {
        ...
        public function __construct() {
            ...
            $this->dir = get_template_directory_uri() . '/lib/gallery-metabox/';
        }
        ...
        function add_meta() {
            ...
            foreach ( $types as $type ) {
                add_meta_box(
                    ...
                    esc_html__( 'Image Gallery', 'wpex-thoughts' ),
                    array( $this, 'render' ),
                    $type,
                    'normal',
                    'high'
        ...
        function render() {
                        ...
                        foreach ( $attachments as $attachment_id ) {
                            if ( wp_attachment_is_image ( $attachment_id  ) ) {
                                echo '<li class="image" data-attachment_id="' . $attachment_id . '"><div class="attachment-preview"><div class="thumbnail">
                                            ...
                                            <a href="#" class="wpex-gmb-remove" title="' . esc_attr__( 'Remove image', 'wpex-thoughts' ) . '"><div class="media-modal-icon"></div></a>
                                        </div></li>';
                            }
                        }
                    } ?>
            ...
            <p class="add_wpex_gallery_images hide-if-no-js">
                <a href="#" class="button-primary"><?php esc_html_e( 'Add/Edit Images', 'wpex-thoughts' ); ?></a>
            </p>
                ...
                jQuery(document).ready(function($){
                    ...
                    jQuery( '.add_wpex_gallery_images' ).on( 'click', 'a', function( event ) {
                        ...
                        image_gallery_frame = wp.media.frames.downloadable_file = wp.media({
                            ...
                            title: "<?php esc_html_e( 'Add Images to Gallery', 'wpex-thoughts' ); ?>",
                            button: {
                                text: "<?php esc_html_e( 'Add to gallery', 'wpex-thoughts' ); ?>",
                            },
                            multiple: true
                        });
                                     ...
                                     $wpex_gallery_images.append('\
                                        <li class="image" data-attachment_id="' + attachment.id + '">\
                                            <div class="attachment-preview">\
                                               ...
                                               <a href="#" class="wpex-gmb-remove" title="<?php echo esc_attr( 'Remove image', 'wpex-thoughts' ); ?>"><div class="media-modal-icon"></div></a>\
                                            </div>\
                                        </li>');
                                }
                            } );
