					  ...
					  $("#jquery_jplayer_<?php echo $post->ID; ?>").jPlayer({
						  ready: function () {
							  $(this).jPlayer("setMedia", {
									poster: "<?php echo esc_url( wp_get_attachment_url( get_post_thumbnail_id(), 'full' ) ); ?>",
									mp3: "<?php echo esc_url( $wpex_post_audio_mp3 ); ?>",
									oga: "<?php echo esc_url( $wpex_post_audio_ogg ); ?>"
							  });
							  },
